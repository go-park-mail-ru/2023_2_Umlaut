...
func TestComplaintPostgres_CreateComplaint(t *testing.T) {
	...
	mock.ExpectQuery(`INSERT INTO "complaint"`).
		WithArgs(testComplaint.ReporterUserId, testComplaint.ReportedUserId, testComplaint.ComplaintTypeId).
...
func TestComplaintPostgres_AcceptComplaint(t *testing.T) {
	...
	mock.ExpectQuery(`UPDATE "complaint"`).
		WithArgs(1, 1).
		WillReturnRows(pgxmock.NewRows([]string{"id", "reporter_user_id", "reported_user_id", "complaint_type_id", "created_at"}).
			AddRow(1, 1, 2, 1, &time.Time{}))
