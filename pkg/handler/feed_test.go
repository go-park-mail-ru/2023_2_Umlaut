...
// func TestHandler_getNextUsers(t *testing.T) {
// 	mockCookie := &http.Cookie{
// 		Name:  "session_id",
// 		Value: "value",
// 	}
// 	mockUser := model.User{Mail: "max@max.ru", PasswordHash: "passWord", Name: "Max"}
// 	mockUsers := []model.User{mockUser, mockUser, mockUser}
// 	response := ClientResponseArrayDto[model.User]{
// 		Status:  200,
// 		Message: "success",
// 		Payload: mockUsers,
// 	}
...
// 			inputCookie: mockCookie,
// 			mockBehavior: func(r *mock_service.MockFeed) {
// 				r.EXPECT().GetNextUsers(gomock.Any(), 1).Return(mockUsers, nil)
// 			},
// 			expectedStatusCode:   http.StatusOK,
// 			expectedResponseBody: string(jsonData),
// 		},
...
// 			inputCookie: mockCookie,
// 			mockBehavior: func(r *mock_service.MockFeed) {
// 				r.EXPECT().GetNextUsers(gomock.Any(), 1).Return(mockUsers, errors.New("some error"))
// 			},
// 			expectedStatusCode:   http.StatusInternalServerError,
// 			expectedResponseBody: `{"status":500,"message":"some error","payload":""}`,
// 		},
...
// 			w := httptest.NewRecorder()
// 			req := httptest.NewRequest("GET", "/api/v1/feed/users", nil)
// 			if test.inputCookie != nil {
// 				req.AddCookie(test.inputCookie)
// 			}
